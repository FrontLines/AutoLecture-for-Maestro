...
- Fully Local Text-To-Speech Engine: Your voice generation happens completely on-device. No APIs, no cloud services, and no tracking.
...
- Integrated Auto-Updater: No need to manually download new zip files! Just right-click the AutoLecture tray icon and click "Check for Updates" to automatically fetch and silently install the latest releases straight from GitHub.
